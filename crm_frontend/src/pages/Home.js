...
export default function Home() {
  ...
  if (graphEvents && graphEvents.length > 0) {
    ...
    for (let num = 0; num < 7; num++) {
      ...
      for (let i = 0; i < graphEvents.length; i++) {
        ...
        if (
          graphDateTime >= earlyStartDate.getTime() &&
          graphDateTime <= lateEndDate.getTime()
        ) {
          graphData[num].value++;
        }
      }
  ...
  const contactRow = (contact, i) => (
    <TableRow key={i}>
      ...
      <TableCell align="center">
        <a
          href={"/contact/profile/" + contact._id}
    ...
    return (
      ...
      >
        <Table stickyHeader>
          ...
          <TableBody>
            {lastFiveContacts.map((contact, i) => contactRow(contact, i))}
          </TableBody>
        </Table>
      </TableContainer>
    );
    ...
    return (
      ...
      >
        <Table stickyHeader>
          ...
          <TableBody>
            {upcomingEvents.map((contact, i) => eventRow(contact, i))}
          </TableBody>
        </Table>
      </TableContainer>
    );
  ...
  const graphMarginStyle = {
    marginTop: "2%",
    marginLeft: "3%",
    marginRight: "8%",
  };
  const eventMarginStyle = {
    marginTop: "0%",
    marginLeft: "7%",
    marginRight: "0%",
  };
  const contactMarginStyle = {
    marginTop: "0%",
    marginLeft: "2%",
    marginRight: "0%",
  };
